...
matching_norm_points=importdata('./data/matching_norm_points.txt');
pts1_n=matching_norm_points(:,1:2);
pts2_n=matching_norm_points(:,3:4);
...
mvSets_txt=importdata('./data/mvSets.txt');
mvSets=mvSets_txt'+1;



[vbMatchesInliersH, SH, H21,R21H,t21H,vP3DH,goodH,errorH] = FindHomography_change(mvMatches12, pts2_n, pts1_n, mvSets, mMaxIterations, mSigma);

[vbMatchesInliersF, SF, F21,R21F,t21F,vP3DF,goodF,errorF] = FindFundamental_change(mvMatches12, pts2_n, pts1_n, mvSets, mMaxIterations, mSigma);
