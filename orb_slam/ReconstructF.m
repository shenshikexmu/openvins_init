function success = ReconstructF(vbMatchesInliers, F21, K, R21, t21, minParallax, minTriangulated)
    % Number of matches
    ...
    R21 = []; t21 = [];  % Initialize output variables
    ...
    % If none of the hypotheses are good enough
    success = false;
end
